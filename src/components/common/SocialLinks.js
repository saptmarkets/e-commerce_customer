  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'footer':
        return {
          container: 'flex',
          icon: 'w-0.5 h-0.5 max-w-0.5 max-h-0.5 sm:w-5 sm:h-5 md:w-5 md:h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7',
          iconSize: 'w-1 h-1 sm:w-2.5 h-2.5 md:w-2.5 md:h-2.5 lg:w-3 h-3 xl:w-3.5 xl:h-3.5',
          anchor: 'w-0.5 h-0.5 max-w-0.5 max-h-0.5 sm:w-5 sm:h-5 md:w-5 md:h-5 lg:w-6 lg:h-6 xl:w-7 xl:h-7',
